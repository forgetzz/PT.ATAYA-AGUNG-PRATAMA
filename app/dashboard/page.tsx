...
<SheetContent side="left" className="w-64 bg-[#800000] text-white p-0 h-screen overflow-y-auto  scrollbar-none">

  <div className="p-4 ">
    <SheetTitle className="text-lg flex justify-center border-b-2 pb-4 border-white text-white items-center font-bold mb-4">Menu Utama</SheetTitle>
      <button
    ...
    <div>
      ...
      >
        ...
        {openNested ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
      </button>
 ...
 {/* Reward */}
   <div>
      ...
      >
        ...
        {openNested4 ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
      </button>
    ...
    {/* Daftar Mitra baru */}
     <div>
      ...
      >
        ...
        {openNested5 ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
      </button>
